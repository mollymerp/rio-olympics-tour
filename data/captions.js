module.exports = {
  "pavilions": [{
    site: "Pavilion 2",
    coordinates: [-43.411736241760366,-22.975439697287996],
    ...
    site: "Pavilion 3",
    coordinates: [-43.41270373218052,-22.97819417916284],
    caption: "Riocentro Pavilion 3 will host table tennis during the Olympic and Paralympic Games."
  }, {
    site: "Pavilion 4",
    coordinates: [-43.41319456444978,-22.980558191842576],
    caption: "Riocentro Pavilion 4 will host the badminton competitions during the Olympic Games."
  }, {
    site: "Pavilion 6",
    coordinates: [-43.41535753107618,-22.979027016023608],
    caption: "Riocentro Pavilion 6 will host the boxing events during the Olympic Games and the sitting volleyball during the Paralympic Games."
  }],
  "olympic-park-2": [{
    site: "Maria Lenk Aquatics Center",
    coordinates: [-43.387758155370165,-22.97491297792783],
    ...
    coordinates: [-43.39062355895868,-22.97629729370783],
  ...
  "olympic-park": [{
    ...
    caption: "Also known as Future Arena, OTC – Hall 4 will host handball during the Olympic Games and goalball during the Paralympic Games."
  }, {
    site: "Olympic Tennis Center",
    coordinates: [-43.39496171657149, -22.97457506815273],
    caption: "The Olympic Tennis Center will host the Olympic tennis competition in 2016 as well as wheelchair tennis and five-a-side football during the Paralympic Games."
  }, {
    site: "Rio Olympic Velodrome",
    coordinates: [-43.39261646283245, -22.975568961377206],
    caption: "Rio Olympic Velodrome will host the track cycling events during the Olympic and Paralympic Games."
  }, {
    site: "Carioca Arena 1",
    coordinates: [-43.39265782556046, -22.976587417858084],
    caption: "Carioca Arena 1 is located in Barra Olympic Park, five minutes from the Olympic and Paralympic Village. During the Olympic Games it will host basketball, then wheelchair basketball and wheelchair rugby during the Paralympic Games."
  }, {
    site: "Carioca Arena 2",
    coordinates: [-43.391971288524076, -22.97756392575525],
    caption: "Carioca Arena 2 is located in Barra Olympic Park, five minutes from the Olympic and Paralympic Village. During the Olympic Games it will host judo and wrestling, then boccia during the Paralympic Games."
  }, {
    site: "Carioca Arena 3",
    coordinates: [-43.39268176646286, -22.978735014168194],
    caption: "Carioca Arena 3 is located in Barra Olympic Park, five minutes from the Olympic and Paralympic Village. During the Olympic Games it will host fencing and taekwondo, then judo during the Paralympic Games."
  }],


  "deodoro": [{
    site: "Youth Arena",
    coordinates: [-43.40536618090775,-22.859244920338128],
    caption: "Youth Arena – inside Deodoro Olympic Park – will host basketball matches and the fencing section of modern pentathlon during the Olympics. Modern pentathlon’s other events will take place at the Deodoro Aquatics Centre (swimming) and the Deodoro Stadium (equestrian and combined event). The Youth Arena will stage the Paralympic wheelchair fencing events."
  }, {
    site: "Deodoro Stadium",
    coordinates:  [-43.40148418703225,-22.85763497162216],
    ...
    coordinates:  [-43.404997329950675,-22.861142054782448],
    caption: "The Deodoro Aquatics Centre will host the swimming section of the modern pentathlon. The sport’s other events will take place at the Youth Arena (fencing) and the Deodoro Stadium (equestrian and combined event)."
  }, {
    site: "Olympic Hockey Center",
    coordinates: [-43.40274917176629,-22.86007677777242],
  ...
  "x-park": [{
    ...
    coordinates: [-43.40249776840213,-22.84847464874379],
    caption: "The Whitewater Stadium will host the canoe slalom events. A permanent 250m long course will remain after the Olympics."
  }, {
    site: "Olympic BMX Center",
    coordinates: [-43.400963544845695,-22.852162448832686],
    ...
    coordinates: [-43.409578800201444,-22.852429390265144],
    caption: "The Mountain Bike Park is approximately 4.8 km long, and features climbs and drops while ensuring that competitors go past the spectator areas more than once during races."
  }],
  "maracana": [{
    site: "Maracanã Stadium",
    coordinates: [-43.228106043645795,-22.909672776061385],
    ...
    coordinates: [-43.229317470607896,-22.914580074675257],
  ...
  "copacabana": [{
    ...
    coordinates: [-43.174487851404024,-22.974885972131432],
    ...
    coordinates: [-43.18913945520302,-22.982444941391506],
  ...
  "track": [{
    ...
    coordinates:  [-43.293966237763215,-22.892174117469466],
  ...
  "race-walk": [{
    site: "Pontal",
    coordinates:  [-43.467880328838646,-23.03236132320926],
  ...
  "equestrian": [{
    ...
    coordinates: [-43.4070327616638,-22.87017574480855],
  ...
  "shooting": [{
    ...
    coordinates: [-43.40940115807916,-22.85735045450309],
  ...
  "golf" : [{
    site: "Olympic Golf Course",
    coordinates: [-43.40220129927073,-23.010678664692406],
    caption: "The Olympic Golf Course is just north of Marapendi Lake in the Barra da Tijuca neighbourhood, approximately 5km from the Olympic and Paralympic Village. After the Games, it will become a public course and training centre with the aim of promoting golf in Brazil and South America."
  }]
